...
import main.java.com.tetrismultiplayer.client.engine.tetromino.TetrominoI;
...
public class TetrominoITest
{
    ...
    {
	tetromino = new TetrominoI(new GamePanel(), Color.BLUE, 100, 100);
    }
	...
	assertEquals(80, all.get(2).getPosition().y);
